        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 1100, nullable: false),
                    Language = table.Column<string>(maxLength: 50, nullable: false),
                    CinemaCategory = table.Column<int>(nullable: false),
                    TrailerPath = table.Column<string>(maxLength: 500, nullable: true),
                    CoverPath = table.Column<string>(maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieProjections_IsDeleted",
                table: "MovieProjections",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewAuthors_IsDeleted",
                table: "ReviewAuthors",
                column: "IsDeleted");
